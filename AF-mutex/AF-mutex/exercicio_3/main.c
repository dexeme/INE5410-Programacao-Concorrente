...
// A solução adotada foi a segunda, de criar um mutex recursivo
...
int main(int argc, char** argv) {
    ...
    //Inicializa o mutex
    // INicie o mutex recursivo
    // Aloque uma variável attrs do tipo pthread_mutexattr_t; 
    // Inicialize a variável attrs com pthread_mutexattr_init(&attrs);
    // Defina o tipo de mutex como recursivo com pthread_mutexattr_settype(&attrs, PTHREAD_MUTEX_RECURSIVE);
    // Inicialize o mutex com pthread_mutex_init(&mutex, &attrs);
    // Destrua a variável attrs com pthread_mutexattr_destroy(&attrs);
